 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			rowsPerPage : 10,
			currPage : 1,
			optionsForRows : [10,20,50,100,500],
			ignoreRows : [],
			topNav : false
		};  
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<a class='tablebuttonleft' id='tablePagination_firstPage'><<</a>");
        htmlBuffer.push("<a class='tablebuttonleft'id='tablePagination_prevPage'><</a>");
        htmlBuffer.push("Page");
        htmlBuffer.push("<input class='tableinput' id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1'>");
        htmlBuffer.push("of <span id='tablePagination_totalPages'>" +totalPages+"</span>");
        htmlBuffer.push("<a class='tablebutton' id='tablePagination_nextPage'>></a>");
        htmlBuffer.push("<a class='tablebutton' id='tablePagination_lastPage'>>></a>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("<span id='tablePagination_perPage'>");
        htmlBuffer.push("<select id='tablePagination_rowsPerPage'></select>");
